...
public class EmailNotificationServiceImpl extends EmailNotificationService {
    ...
    @Override
    public void sendConfirmationEmail(String to, UUID orderId) {
    ...
    @Override
    public void sendConfirmationEmail(String to, UUID orderId, List<String> unavailableProducts) {
        try {
            SimpleMailMessage message = new SimpleMailMessage();
            message.setTo(to);
    ...
    @Override
    public void sendDeclineEmail(String to, UUID orderId, List<String> unavailableProducts) {
        try {
            SimpleMailMessage message = new SimpleMailMessage();
            message.setTo(to);
